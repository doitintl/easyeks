...
export function enable_logs_observability_via_cloudwatch(config: Easy_EKS_Config_Data, stack: cdk.Stack, cluster: eks.ICluster, input: EKS_Logs_via_CloudWatch_Input_Parameters){
    ...
    const amazon_cloudwatch_ns = new eks.KubernetesManifest(stack, "amazon-cloudwatch-namespace",
        {
            cluster: cluster,
